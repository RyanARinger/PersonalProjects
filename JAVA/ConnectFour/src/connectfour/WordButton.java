...
public class WordButton extends JLabel{
    ...
    private final Font RESTINGVERANDA = new Font("Veranda", 1, 20);
    private final Font ACTIVEVERANDA = new Font("Veranda", 1, 25);
    private final Color RESTINGCOLOR = Color.BLACK;
